...
from dataset.SiameseDatasetCheXpert import SiameseDatasetCheXpert
import matplotlib.pyplot as plt
import argparse


parser = argparse.ArgumentParser('Evaluate Trained Model On CheXpert Data')
...
test_set = SiameseDatasetCheXpert(phase='testing', n_channels=3, n_samples=792294, transform=transform,
...
plt.title('ROC Curve')
plt.legend()
plt.savefig('./archive/trained_model_ROC_curve_cheXpert.png')
